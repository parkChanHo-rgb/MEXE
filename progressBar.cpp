...
HRESULT progressBar::init(int x, int y, int width, int height)
{
	...
	_progressBarFront = IMAGEMANAGER->addImage("frontBar", "image/hpBarTop.bmp", width, height, true, RGB(255, 0, 255));
	_progressBarBack = IMAGEMANAGER->addImage("backBar", "image/hpBarBottom.bmp", width, height, true, RGB(255, 0, 255));
